...
# from utils import networks
from human_parser import networks
from utils.utils.transforms import transform_logits
from utils.datasets.simple_extractor_dataset import SimpleFolderDataset
...
def human_parser_run(model_root, input_path, output_path):
    print('human_parser run test in otesbro')
    ...
    state_dict = torch.load(model_root)['state_dict']
