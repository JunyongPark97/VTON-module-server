...
class Pix2PixHDModel(BaseModel):
    ...
    def forward(self, label, pre_clothes_mask, img_fore, clothes_mask, clothes, all_clothes_label, real_image, pose,grid,mask_fore):
        ...
        acgpn_tmp_path = os.getenv('HOME') + '/Desktop/otesbro/otesbro/otes/ACGPN/DeepFashion_Try_On/Data_preprocessing'

        img = Image.open(acgpn_tmp_path + '/test_warped_mask/model_cut.png')
        ...
        print(label[0][0][80])
        new_g1 = self.create_arm_label(acgpn_tmp_path + '/test_pose/real_cut_keypoints.json', label, all_clothes_label, w_mask)
        ##
